...
Explore my latest projects and articles, showcasing my expertise in React.js and web development.
              ...
              <div className='flex items-center self-start wt-2 lg:self-center'>
                ...
                className='ml-4 text-lg font-medium capitalize text-dark underline justify-center dark:text-light md:text-base'
                >Contact</Link>
              </div>
            </div>
          </div>
